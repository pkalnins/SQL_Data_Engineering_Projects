...
A SQL Project analyzing the data engineer job market using real world job postings data. It demonstrates my ability to **write production-quality analytical SQL, design efficient queries, and turn business questions into data-driven insights**
