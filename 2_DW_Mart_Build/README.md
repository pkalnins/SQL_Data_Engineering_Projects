...
- **SQL Files:**
    - `05_create_priority_mart.sql` – Initial build of priority roles and jobs snapshot
...
- **Star Schema Design:** Fact table (`job_postings_fact`) with dimension tables (`company_dim`, s`kills_dim`)
